...
// application catalog pages
const AppCatalogProducts = Loadable(lazy(() => import('views/application/catalog/Products')));
const AppCatalogProductDetails = Loadable(lazy(() => import('views/application/catalog/ProductDetails')));
const AppCatalogProductList = Loadable(lazy(() => import('views/application/catalog/ProductList')));
const AppCatalogCheckout = Loadable(lazy(() => import('views/application/catalog/Checkout')));
...
const MainRoutes = {
    ...
    children: [
...

        {
            ...
            element: <AppCatalogProducts />
        },
        {
            path: '/catalog/product-details/:id',
            element: <AppCatalogProductDetails />
        },
        {
            path: '/catalog/product-list',
            element: <AppCatalogProductList />
        },
        {
            path: '/catalog/checkout',
            element: <AppCatalogCheckout />
        },
